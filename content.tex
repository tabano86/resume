...
%   SUMMARY
%----------------------------------------------------------------------------------------
\noindent \textbf{Senior Software Engineer} with 12+ years of experience translating complex business needs into mission-critical technology. Acknowledged as a SME for defining architectural roadmaps and delivering scalable solutions using Java, Spring Boot, and TypeScript in cloud-native environments. My unique background (Aerospace Engineering origins) provides a rigorous, methodical approach to solving challenges in any high-stakes environment.
